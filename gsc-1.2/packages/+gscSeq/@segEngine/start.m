function ok=start(obj,labelImg, customPosterior )
...
if customPosterior < 0,
    [posteriorImage fgPosterior bgPosterior] =gscSeq.getPosteriorImage(obj.features,labelImg,obj.opts);
    obj.posteriorImage=posteriorImage;
    obj.fgPosterior =fgPosterior;
    obj.bgPosterior = bgPosterior;
    posteriorImage=posteriorImage(:)';
else
    obj.posteriorImage=customPosterior;
    posteriorImage = customPosterior(:)';
end
